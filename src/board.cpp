...
i32 Board::get_drop_distance(const Piece::Data& piece)
{
    i32 result = 64;
    for (i32 i = 0; i < 4; ++i) {
...
bool Board::is_colliding(const Piece::Data& piece)
{
    for (i32 i = 0; i < 4; ++i) {
        i8 cell_x = piece.x + Piece::get_offset_x(piece.type, piece.r, i);
        i8 cell_y = piece.y + Piece::get_offset_y(piece.type, piece.r, i);
...
bool Board::is_above_stack(const Piece::Data& piece)
{
    for (i32 i = 0; i < 4; ++i) {
        i8 cell_x = piece.x + Piece::get_offset_x(piece.type, piece.r, i);
        i8 cell_y = piece.y + Piece::get_offset_y(piece.type, piece.r, i);
...
bool Board::is_tspin(const Piece::Data& piece)
{
...
void Board::place_piece(const Piece::Data& piece)
{
    for (int i = 0; i < 4; ++i) {
        i8 cell_x = piece.x + Piece::get_offset_x(piece.type, piece.r, i);
        i8 cell_y = piece.y + Piece::get_offset_y(piece.type, piece.r, i);
